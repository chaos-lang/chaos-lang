...
static char tk_transition[TK_LENGTH][TK_TRANSITION] = {
  ...
  [TK_TICK][TK_ESC] = TK_CHAR_ESCD,

  [TK_CHAR_ESCD][TK_NONE ... TK_RCURLY] = TK_GENERIC,
  [TK_CHAR_ESCD][TK_EQUALS ... TK_INT] = TK_GENERIC,
  ...
  /* Quote Handling */
  [TK_QUOT][TK_NONE ... TK_RCURLY] = TK_STRING_RUN,
  [TK_QUOT][TK_EQUALS ... TK_TICK] = TK_STRING_RUN,
  [TK_QUOT][TK_ESC]  = TK_STRING_ESCD,
  [TK_QUOT][TK_QUOT] = TK_QUOT_QUOT,
  [TK_QUOT][TK_INT]  = TK_STRING_RUN,

  /* String Run Handling */
  [TK_STRING_RUN][TK_NONE ... TK_RCURLY] = TK_STRING_RUN,
  [TK_STRING_RUN][TK_EQUALS ... TK_TICK] = TK_STRING_RUN,
  [TK_STRING_RUN][TK_ESC]  = TK_STRING_ESCD,
  [TK_STRING_RUN][TK_QUOT] = TK_STRING,
  [TK_STRING_RUN][TK_INT]  = TK_STRING_RUN,

  [TK_STRING_ESCD][TK_NONE ... TK_RCURLY] = TK_STRING_RUN,
  [TK_STRING_ESCD][TK_EQUALS ... TK_INT]  = TK_STRING_RUN,

  /* Multistring Quote Handling */
  [TK_QUOT_QUOT][TK_QUOT] = TK_MULTISTRING_RUN,
  [TK_MULTISTRING_RUN][TK_QUOT] = TK_MULTISTRING_QUOT,
  [TK_MULTISTRING_QUOT][TK_QUOT] = TK_MULTISTRING_QUOT_QUOT,
  [TK_MULTISTRING_QUOT_QUOT][TK_QUOT] = TK_MULTISTRING,

  /* Multistring Run Handling */
  [TK_MULTISTRING_RUN][TK_NONE ... TK_ESC] = TK_MULTISTRING_RUN,
  [TK_MULTISTRING_RUN][TK_INT] = TK_MULTISTRING_RUN,

  [TK_MULTISTRING_QUOT][TK_NONE ... TK_ESC] = TK_MULTISTRING_RUN,
  [TK_MULTISTRING_QUOT][TK_INT] = TK_MULTISTRING_RUN,

  [TK_MULTISTRING_QUOT_QUOT][TK_NONE ... TK_ESC] = TK_MULTISTRING_RUN,
  [TK_MULTISTRING_QUOT_QUOT][TK_INT] = TK_MULTISTRING_RUN,
