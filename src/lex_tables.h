...
enum lexer_state {
  ...
  LS_EQUALS_TERMINAL,
  LS_COLON_TERMINAL,
  LS_OPEN_PAREN_TERMINAL,
  LS_CLOSE_PAREN_TERMINAL,
  LS_RARROW_TERMINAL,
  LS_IMPURE_TERMINAL,
...
transitions[LS_NONTERMINALS_END][EQCLASS_LENGTH] = {
  ...
  [LS_START][EQCLASS_OPEN_PAREN]                 = LS_OPEN_PAREN_TERMINAL,
  [LS_START][EQCLASS_CLOSE_PAREN]                = LS_CLOSE_PAREN_TERMINAL,
  ...
  [LS_WHITESPACE][EQCLASS_OPEN_PAREN]            = LS_OPEN_PAREN_TERMINAL,
  [LS_WHITESPACE][EQCLASS_CLOSE_PAREN]           = LS_CLOSE_PAREN_TERMINAL,
  ...
  [LS_NEWLINE][EQCLASS_OPEN_PAREN]               = LS_NEWLINE_TERMINAL,
  [LS_NEWLINE][EQCLASS_CLOSE_PAREN]              = LS_NEWLINE_TERMINAL,
  ...
  [LS_IDENT][EQCLASS_OPEN_PAREN]                 = LS_IDENT_TERMINAL,
  [LS_IDENT][EQCLASS_CLOSE_PAREN]                = LS_IDENT_TERMINAL,
  ...
  [LS_NUMBER][EQCLASS_OPEN_PAREN]                = LS_NUMBER_TERMINAL,
  [LS_NUMBER][EQCLASS_CLOSE_PAREN]               = LS_NUMBER_TERMINAL,
  ...
  [LS_SEEN_EQUALS][EQCLASS_OPEN_PAREN]           = LS_EQUALS_TERMINAL,
  [LS_SEEN_EQUALS][EQCLASS_CLOSE_PAREN]          = LS_EQUALS_TERMINAL,
  ...
  [LS_SEEN_COLON][EQCLASS_OPEN_PAREN]            = LS_COLON_TERMINAL,
  [LS_SEEN_COLON][EQCLASS_CLOSE_PAREN]           = LS_COLON_TERMINAL,
  ...
  [LS_SEEN_MINUS][EQCLASS_OPEN_PAREN]            = LS_OPERATOR_TERMINAL,
  [LS_SEEN_MINUS][EQCLASS_CLOSE_PAREN]           = LS_OPERATOR_TERMINAL,
  ...
  [LS_SEEN_DOT][EQCLASS_OPEN_PAREN]              = LS_OPERATOR_TERMINAL,
  [LS_SEEN_DOT][EQCLASS_CLOSE_PAREN]             = LS_OPERATOR_TERMINAL,
  ...
  [LS_SEEN_RARROW][EQCLASS_OPEN_PAREN]           = LS_RARROW_TERMINAL,
  [LS_SEEN_RARROW][EQCLASS_CLOSE_PAREN]          = LS_RARROW_TERMINAL,
  ...
  [LS_SEEN_IMPURE][EQCLASS_OPEN_PAREN]           = LS_IMPURE_TERMINAL,
  [LS_SEEN_IMPURE][EQCLASS_CLOSE_PAREN]          = LS_IMPURE_TERMINAL,
  ...
  [LS_SEEN_DOT_2][EQCLASS_OPEN_PAREN]            = LS_OPERATOR_TERMINAL,
  [LS_SEEN_DOT_2][EQCLASS_CLOSE_PAREN]           = LS_OPERATOR_TERMINAL,
  ...
  [LS_SEEN_DOT_3][EQCLASS_OPEN_PAREN]            = LS_ELLIPSIS_TERMINAL,
  [LS_SEEN_DOT_3][EQCLASS_CLOSE_PAREN]           = LS_ELLIPSIS_TERMINAL,
  ...
  [LS_OPERATOR][EQCLASS_OPEN_PAREN]              = LS_OPERATOR_TERMINAL,
  [LS_OPERATOR][EQCLASS_CLOSE_PAREN]             = LS_OPERATOR_TERMINAL,
...
stateful_char_increments[LS_TERMINALS_END] = {
  ...
  [LS_COLON_TERMINAL]                  = 0,
  [LS_OPEN_PAREN_TERMINAL]             = 1,
  [LS_CLOSE_PAREN_TERMINAL]            = 1,
